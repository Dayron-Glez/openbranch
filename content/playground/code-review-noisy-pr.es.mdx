...
sandbox_template: code-review-noisy-pr
skills:
  - Leer diffs
  - Comentarios inline
...
checklist:
  - id: "return-type"
    text: "Señala la línea que cambia el tipo de retorno público"
  - id: "review-decision"
    text: "Tu decisión de revisión es defendible dado el estado del diff"
  - id: "actionable-comments"
    text: "Cada comentario que dejaste es específico y accionable"
---
