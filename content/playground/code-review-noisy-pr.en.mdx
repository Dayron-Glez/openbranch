...
checklist:
  - id: "return-type"
    text: "Flag the line that changes the public return type"
  - id: "review-decision"
    text: "Your review decision is defensible given the state of the diff"
  - id: "actionable-comments"
    text: "Every comment you left is specific and actionable"
---
