...
export function TopicCard({
  ...
  return (
    <Link
      href={href}
      className="group border-line bg-bg-card hover:border-line-2 hover:bg-bg-hover flex flex-col gap-3 overflow-hidden rounded-(--r-12) border px-7 pt-7 pb-6 text-inherit no-underline transition-[background,border-color] duration-(--d-base) ease-(--ease) max-[520px]:gap-2 max-[520px]:px-4 max-[520px]:pt-5 max-[520px]:pb-4"
    >
