...
const eyebrowClass =
  "mb-3.5 inline-block font-mono text-[length:var(--text-sm)] uppercase tracking-[0.08em] text-fg-muted"
...
const headingClass =
  "m-0 mb-[18px] text-balance text-[length:var(--text-7xl)] font-medium leading-[1.05] tracking-[0] max-[980px]:text-[length:var(--text-5xl)]"
