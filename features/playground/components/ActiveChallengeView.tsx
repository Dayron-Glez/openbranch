...
import type { InlineComment, ReviewDecision } from "@/features/playground/domain/review-types"
import type { PlaygroundDict } from "@/lib/playground-dictionary"
import type { DiffFile } from "@/features/playground/components/DiffViewer"
import { DiffViewer } from "@/features/playground/components/DiffViewer"
import { ReviewPanel } from "@/features/playground/components/ReviewPanel"
import { ChallengeLayout } from "@/features/playground/components/ChallengeLayout"
import { ChallengeSidebarHeader } from "@/features/playground/components/ChallengeSidebarHeader"
import { useChallengeSubmit } from "@/features/playground/hooks/useChallengeSubmit"
        ...
        <div className="workspace:overflow-y-auto workspace:pb-10 min-w-0">
          {diffFiles === null ? (
            <div className="border-line bg-bg-elev flex h-full min-h-50 items-center justify-center rounded-(--r-12) border border-dashed">
              <p className="text-fg-muted font-mono text-xs">Diff not available</p>
            </div>
          ) : (
            <DiffViewer
              files={diffFiles}
